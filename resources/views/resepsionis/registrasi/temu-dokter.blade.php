    ...
    <div class="dashboard-container">
        <aside class="sidebar">
          ...
          <ul class="sidebar-menu">
            <li><a href="{{ route('resepsionis.dashboard') }}" >Dashboard</a></li>
                ...
                <li><a href="{{ route('resepsionis.registrasi.temudokter') }}" class="active">Registrasi Temu Dokter</a></li>
        ...
        <main class="main-content">
            {{-- <div class="form-section">
                ...
                <form action="temu_dokter.php" method="post" class="form-container">
                    <div class="form-group">
                        <label for="tanggal">Tanggal Pertemuan:</label>
                    <input type="date" id="tanggal" name="tanggal" value="<?php echo $tanggal_hari_ini; ?>" required readonly>
                </div>
                <div class="form-group">
                    ...
                    <select id="idpet" name="idpet" required>
                        ...
                        <?php while($row = $pet_result->fetch_assoc()): ?>
                            <option value="<?php echo $row['idpet']; ?>">
                                <?php echo htmlspecialchars($row['nama_pet'] . ' (' . $row['nama_pemilik'] . ')'); ?>
                            </option>
                        <?php endwhile; ?>
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select id="idrole_user_dokter" name="idrole_user_dokter" required>
                        ...
                        <?php while($row = $dokter_result->fetch_assoc()): ?>
                            <option value="<?php echo $row['idrole_user']; ?>">
        ...
        <div class="table-section">
            ...
            <table class="styled-table">
                ...
                <tbody>
                        ...
                        <tr>
                            <td colspan="6">Belum ada antrian untuk hari ini.</td>
                        </tr>
                </tbody>
            </table>
        </div>
